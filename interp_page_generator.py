...
def generate_overview_page_for_project(output_folder_path, project_name: str, project_interpretation_folder_path: str, project_interpretation_pages: list):
    doc = dominate.document(title=f'Overview of interpretations generated for {project_name}')
    with doc.head:
...
def main():
    ...
    projects = ['ewolff_microservice', 'shabbirdwd53_springboot_microservice', 'spring-petclinic_spring-petclinic-microservices', 'sqshq_piggymetrics']
